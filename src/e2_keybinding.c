...
//	g_strconcat("\t\t\t|/||",_A(6),".",_A(49),"|",NULL),  //"find"
	...
	g_strconcat("\t\t\t|Menu||",_A(13),".",_A(88),"|",NULL),  //"show menu"
	g_strconcat("\t\t\t|<Shift>Menu||",_A(13),".",_A(88),"|",_A(121),NULL), //"show menu, shift"
	g_strconcat("\t\t\t|<Control>Menu||",_A(13),".",_A(88),"|",_A(113),NULL),  //"show menu, ctrl"
...
//CHECKME these stay as command-line bindings ??
	...
	g_strconcat("\t\t",_C(28),"||||",NULL),  //_("output"
	g_strconcat("\t\t\t|Menu||",_A(10),".",_A(88),"|",NULL), //"show_menu
